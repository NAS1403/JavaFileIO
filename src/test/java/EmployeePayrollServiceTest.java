...
public class EmployeePayrollServiceTest {
    ...
    void given3EmployeesWhenWrittenToFileShouldMatchEmployeeEntries(){
        ...
        EmployeePayrollData employeePayrollData1 = new EmployeePayrollData(1,"Abhi",30000);
        EmployeePayrollData employeePayrollData2 = new EmployeePayrollData(1,"Sagar",3000);
        EmployeePayrollData employeePayrollData3 = new EmployeePayrollData(1,"aaa",10000);
